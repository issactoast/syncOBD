...
# Abstract
abstract: |
  This report illustrates how I approaches the project and the decision making process for the analysis. The goal of this project is to find a best matched trip for given telematics data from either smartphone or OBD2 device.
  The instruction manual will be provided in the later chapter. The implemation code follows Google's R code style guide.
